...
func createNodeImpl(
	...
	batchPoster, err := getBatchPoster(ctx, config, configFetcher, txOptsBatchPoster, dapWriters, l1Reader, inboxTracker, txStreamer, arbOSVersionGetter, consensusDb, syncMonitor, deployInfo, parentChainID, dapRegistry, stakerAddr)
	if err != nil {
		return nil, err
	}
